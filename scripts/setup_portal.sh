...
def make_card(href, icon_key, title, sub, desc, onclick=None):
    ...
    if onclick:
        return f'''<a class="card" href="#" onclick="{onclick}; return false;">{icon}<div class="card-text"><div class="card-title">{title}</div><div class="card-sub">{sub}</div><div class="card-desc">{desc}</div></div></a>'''
    return f'''<a class="card" href="{href}">{icon}<div class="card-text"><div class="card-title">{title}</div><div class="card-sub">{sub}</div><div class="card-desc">{desc}</div></div></a>'''
